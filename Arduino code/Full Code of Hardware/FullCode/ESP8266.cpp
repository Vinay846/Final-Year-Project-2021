...
int ESP8266::httpGet()
{
//  https://smart-dustbin-backend.herokuapp.com/points/123456-10
  char* request =  "GET /points/123456-10 HTTP/1.1\r\nHost: smart-dustbin-backend.herokuapp.com\r\nConnection: close\r\n\r\n";
//  char* request =  "GET /maps/api/geocode/json?latlng=24.9047,67.11885&sensor=true HTTP/1.1\r\nHost: maps.googleapis.com\r\nConnection: close\r\n\r\n";
  
//  char* request = "POST /postapi HTTP/1.1\r\nHost: aktudata-backend.herokuapp.com\r\nContent-Type: application/json\r\nContent-Length: 30\r\nConnection: close\r\n\r\n{\r\n\t\"id\": \"123456\"\r\n\t}\r\n";


  if (createTCP("smart-dustbin-backend.herokuapp.com", 80))
  {
